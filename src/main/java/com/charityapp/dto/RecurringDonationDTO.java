...
public class RecurringDonationDTO {
    ...
    public RecurringDonationDTO() {}
    public RecurringDonationDTO(int recurringDonationId, int donorId, String entityType, int entityId, int charityId, String recurringRate, BigDecimal amount, Date lastInstallment, Date nextInstallment, Date startDate, Date endDate, boolean isActive, int primaryPaymentMethodId) {
