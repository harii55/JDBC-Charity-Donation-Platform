...
public class FundraiserTransaction {
    ...
    public FundraiserTransaction() {}

    public FundraiserTransaction(int transactionId, int donorId, int fcampaignId, BigDecimal amount, Timestamp timestamp, String receiptStatus) {
